                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <form action="{{ route('admin.laporan_peminjaman') }}" method="POST" target="_blank">
                            ...
                            <div class="mt-4">
                                ...
                                <input class="form-control" type="date" name="tgl_peminjaman" id="" required>
                            </div>
                            <div class="row mt-3">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <form action="{{ route('admin.laporan_pengembalian') }}" method="POST" target="_blank">
                            ...
                            <div class="mt-4">
                                ...
                                <input class="form-control" type="date" name="tgl_pengembalian" id="" required>
                            </div>
                            <div class="row mt-3">
                                <button class="btn btn-danger" type="submit">P D F</button>
